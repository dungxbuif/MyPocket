...
Giá, phí, giá vốn, lãi/lỗ và valuation dùng số nguyên VND trong miền `int64`. Phép nhân số lượng với giá được làm tròn trước khi kiểm tra giới hạn; phép cộng/trừ không được wrap thành số sai. Lệnh tạo/sửa trade hoặc giá gây overflow trả lỗi validation và rollback dữ liệu, version và change feed. Nếu tổng danh mục vượt miền biểu diễn, API trả lỗi thay vì trả một tổng âm sai. Bản kiểm chứng local 11/09/2026 chưa phải thông báo deploy.
