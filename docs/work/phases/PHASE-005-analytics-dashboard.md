...
| --- | --- | --- | --- | --- |
| TICKET-015 | Ticket | PWA navigation, search, and wallet views | planned | Created during implementation planning |
| TICKET-016 | Ticket | Overview and net-worth dashboard | planned | Created during implementation planning |
| TICKET-017 | Ticket | Analytics reports and cumulative trends | planned | Created during implementation planning |
