...
- Secrets stay in ignored `.env.local`, never staged. Owner-supplied visual evidence is kept under `docs/design/references/` and is excluded from runtime checkpoints.
