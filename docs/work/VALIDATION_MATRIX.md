...
| REQ-F-016 | PHASE-001/005 | TICKET-001/015..017 | Installable Vietnamese/VND PWA navigation and workflows | yes | yes | yes | yes | yes | yes | in_progress | Mobile shell tests, build, manifest/service worker, screenshots, Playwright offline reload, and PHASE-002 mobile finance component workflow tests pass from `frontend/`; later analytics/planning workflows remain pending |
