...
| REQ-F-002 | PHASE-002 | TICKET-005/007 | Wallets, category hierarchy, activation, archive, and seeds | yes | yes | yes | yes | no | yes | in_progress | PHASE-002 migration/schema/seed, backend wallet/category repository, initial wallet/category HTTP route, and API-driven mobile display proof recorded in [PHASE-002 finance verification](test-verification/PHASE-002-finance-core.md); remaining mutation routes and full wallet/category UAT remain pending |
| REQ-F-003 | PHASE-002 | TICKET-006 | Atomic income, expense, transfer, adjustment, edit, and search | yes | yes | yes | yes | no | yes | in_progress | TICKET-006 domain and repository proof covers income, expense, transfer, adjustment, atomic wallet balance/version updates, user-owned wallet checks, category activation checks, and duplicate idempotent create replay in [PHASE-002 finance verification](test-verification/PHASE-002-finance-core.md); edit/archive, search, API, E2E, and UAT remain pending |
...
| REQ-NF-002 | PHASE-002/003/004 | TICKET-006/009/013 | Integer money, atomic writes, and idempotent retries | yes | yes | yes | not_required | no | yes | in_progress | TICKET-006 unit and integration proof covers integer VND accounting effects, database transaction balance updates, and duplicate idempotent create replay; edit/archive idempotency and later sync/planning retry behavior remain pending |
...
| REQ-NF-005 | PHASE-002/004/005 | TICKET-006/011/017 | VND integers and Ho Chi Minh reporting boundaries | yes | yes | yes | yes | yes | yes | in_progress | TICKET-006 unit and integration proof covers VND integer balance effects and persisted VND integer transaction amounts; Ho Chi Minh reporting boundaries remain pending in transaction search/reporting work |
