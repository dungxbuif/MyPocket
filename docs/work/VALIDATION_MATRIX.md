...
| REQ-F-003 | PHASE-002 | TICKET-006 | Atomic income, expense, transfer, adjustment, edit, and search | yes | yes | yes | yes | no | yes | in_progress | TICKET-006 domain accounting effect proof covers income, expense, transfer, and adjustment balance deltas in [PHASE-002 finance verification](test-verification/PHASE-002-finance-core.md); repository atomicity, idempotency, edit/archive, search, API, E2E, and UAT remain pending |
...
| REQ-NF-002 | PHASE-002/003/004 | TICKET-006/009/013 | Integer money, atomic writes, and idempotent retries | yes | yes | yes | not_required | no | yes | in_progress | TICKET-006 unit proof covers integer VND accounting effects; database atomicity, retry idempotency, and later sync/planning retry behavior remain pending |
...
| REQ-NF-005 | PHASE-002/004/005 | TICKET-006/011/017 | VND integers and Ho Chi Minh reporting boundaries | yes | yes | yes | yes | yes | yes | in_progress | TICKET-006 unit proof covers VND integer balance effects; Ho Chi Minh reporting boundaries remain pending in transaction search/reporting work |
