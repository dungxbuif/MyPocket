...
| REQ-F-005 | PHASE-004 | TICKET-011..014 | Budgets, events, recurring drafts, debts, and alerts | yes | yes | yes | yes | yes | yes | in_progress | TICKET-011 proof covers budget CRUD, period validation, selected/all expense category scopes, confirmed-expense progress formulas, threshold dedupe, and mobile budget CRUD. TICKET-012 proof covers event CRUD/linking/totals, report exclusion preservation, obligation CRUD, repayment linking, overpayment rejection, and mobile event/debt flows in [PHASE-004 planning verification](test-verification/PHASE-004-planning-automation.md); recurring drafts, inbox, and full UAT remain pending |
...
| REQ-NF-005 | PHASE-002/004/005 | TICKET-006/011/012/017 | VND integers and Ho Chi Minh reporting boundaries | yes | yes | yes | yes | yes | yes | in_progress | TICKET-006 unit and integration proof covers VND integer balance effects, persisted VND integer transaction amounts, and date-range search inputs; TICKET-011 adds Ho Chi Minh budget period boundary proof and VND integer progress calculations; TICKET-012 adds integer VND event totals and debt remaining calculations; broader reporting boundary UAT remains pending |
