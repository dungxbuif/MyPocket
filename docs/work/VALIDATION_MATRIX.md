...
| REQ-F-016 | PHASE-001/005 | TICKET-001/015..017 | Installable Vietnamese/VND PWA navigation and workflows | yes | yes | yes | yes | yes | yes | in_progress | Tailwind v4/Vite integration, base UI primitives, mobile shell/search/dashboard/report UI, compact wallet list/sheet with create-wallet entry, liquid-glass bottom nav/sheets, transparent scrollbars, service worker push handling, React tests, and production build pass; desktop and live analytics UAT remain |
