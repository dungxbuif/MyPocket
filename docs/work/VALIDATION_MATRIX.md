...
| REQ-F-005 | PHASE-004 | TICKET-011..014 | Budgets, events, recurring drafts, debts, and alerts | yes | yes | yes | yes | yes | yes | in_progress | TICKET-011 proof covers budget CRUD, weekly/monthly/quarterly/yearly/custom period validation, selected/all expense category scopes, confirmed-expense progress formulas, 80/100 threshold dedupe, and mobile budget create/edit/archive in [PHASE-004 planning verification](test-verification/PHASE-004-planning-automation.md); events, debts, recurring drafts, inbox, and full UAT remain pending |
...
| REQ-NF-005 | PHASE-002/004/005 | TICKET-006/011/017 | VND integers and Ho Chi Minh reporting boundaries | yes | yes | yes | yes | yes | yes | in_progress | TICKET-006 unit and integration proof covers VND integer balance effects, persisted VND integer transaction amounts, and date-range search inputs; TICKET-011 adds Ho Chi Minh budget period boundary proof and VND integer progress calculations; broader reporting boundary UAT remains pending |
