...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | BL-001 | phase | high-risk | Platform and Identity | Urgent | in_progress | [PHASE-001](phases/PHASE-001-platform-identity.md), [detail design](phases/PHASE-001-detail-design.md), [plan](../superpowers/plans/2026-08-25-phase-001-platform-identity.md) | Auth, Authorization, Data model, Public API, Deployment/runtime | Add browser E2E proof for PWA offline/auth flows | Runtime/API foundation, PostgreSQL migrations, S3-compatible adapter, backend identity, mobile PWA shell, and local compose smoke are verified; browser E2E remains. |
