...
| 2 | BL-002 | phase | high-risk | Finance Core | High | ready | [PHASE-002](phases/PHASE-002-finance-core.md) | Data model, Existing behavior, Public API, Multi-domain | TICKET-005..007 and implementation plan | PHASE-001 implementation is in review; finance decomposition can start. |
