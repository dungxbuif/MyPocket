...
Owner direction 2026-09-13: Markdown is the design contract and declared visual-reference bundles remain evidence under `docs/design/references/`; source observations are preserved in `docs/design/system/SOURCE_EXTRACTION.md`. Create/update the behavior spec as each page is implemented, using `docs/design/pages/README.md`. This supersedes older mandatory code.html/screen.png synchronization language.
