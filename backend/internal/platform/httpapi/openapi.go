...
var versionedRoutes = []RouteDescriptor{
	...
	route("GET", "/api/v1/recurring-schedules", "List recurring schedules", true, false, false), route("POST", "/api/v1/recurring-schedules", "Create recurring schedule", true, true, false), route("PATCH", "/api/v1/recurring-schedules/{id}", "Update recurring schedule", true, true, false), route("POST", "/api/v1/recurring-schedules/{id}/pause", "Pause recurring schedule", true, true, false), route("POST", "/api/v1/recurring-schedules/{id}/resume", "Resume recurring schedule", true, true, false), route("POST", "/api/v1/recurring-schedules/{id}/archive", "Archive recurring schedule", true, true, false), route("GET", "/api/v1/transaction-drafts", "List transaction drafts", true, false, false), route("POST", "/api/v1/transaction-drafts/{id}/confirm", "Confirm draft", true, true, true), route("POST", "/api/v1/transaction-drafts/{id}/reject", "Reject draft", true, true, false),
	...
	route("POST", "/api/v1/agent/intakes", "Create transaction intake session message", true, true, true), route("POST", "/api/v1/agent/intakes/{id}/messages", "Continue transaction intake session", true, true, true), route("GET", "/api/v1/agent/intakes/{id}", "Get transaction intake history", true, false, false), route("POST", "/api/v1/agent/advisor/messages", "Queue read-only advisor message", true, true, true), route("POST", "/api/v1/agent/messages", "Queue compatible agent request", true, true, true), route("GET", "/api/v1/agent/runs/{id}", "Get agent run", true, false, false),
