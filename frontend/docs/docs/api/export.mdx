...
> Trạng thái đối chiếu 2026-09-08: export vẫn **planned**, chưa có handler `/api/v1/exports` trong router. Khối bên dưới là thiết kế dự kiến, không phải endpoint dùng được. Upload/download ảnh ở phần sau đã có implementation và không bao gồm OCR.
