...
> Cập nhật 2026-09-11: route tài chính, planning, portfolio, báo cáo, notification, sync, import/export và account lifecycle đã có trong OpenAPI 3.1 máy đọc. AI/OCR được phát hành ở phase riêng; không suy diễn endpoint chưa có trong `/api/v1/openapi.json`.
