...
export default defineConfig({
  ...
  webServer: [
    {
      command: 'cd ../backend && DATABASE_URL="postgres://mypocket:mypocket@127.0.0.1:55433/mypocket?sslmode=disable" go run ./cmd/migrate && APP_ENV=test DATABASE_URL="postgres://mypocket:mypocket@127.0.0.1:55433/mypocket?sslmode=disable" PUBLIC_WEB_URL="http://127.0.0.1:4173" COOKIE_SECRET="change-this-development-cookie-secret-32-bytes" CSRF_SECRET="change-this-development-csrf-secret-32-bytes" HTTP_ADDR="127.0.0.1:18173" OAUTH_FIXTURE_MODE=true go run ./cmd/api',
