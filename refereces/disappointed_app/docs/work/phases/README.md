...
Use this folder for multi-ticket work packages.
...
```text
PHASE-<id>-<short-name>.md
```

Example:

```text
PHASE-001-framework-scaffold.md
```
...
Start from `docs/templates/PHASE.md`.

## MyPocket Phases

1. [PHASE-001 Platform and Identity](PHASE-001-platform-identity.md)
2. [PHASE-002 Finance Core](PHASE-002-finance-core.md)
